...
-   [**Data-Structures (Java)**](data-structures/README.md)
    ...
    -   [Bit Manipulation](data-structures/bit-manipulation.md)
    -   [Common Problems](data-structures/common-problems.md)
    -   [Comparators](data-structures/comparators.md)
    -   [Complexity](data-structures/complexity.md)
    -   [Deque](data-structures/dequeue.md)
    -   [Depth First Search](data-structures/dfs.md)
    -   [Graph](data-structures/graph.md)
    -   [Linked List](data-structures/linked-list.md)
    -   [Map](data-structures/map.md)
    -   [Math](data-structures/math.md)
    -   [Priority Queue](data-structures/priority-queue.md)
    -   [Search Algorithms](data-structures/search-algorithms.md)
    -   [Snippets](data-structures/snippets.md)
    -   [Sorting Algorithms](data-structures/sorting-algorithms.md)
...
-   [**System Design**](system-design/README.md)
    -   [Pastebin System Design](system-design/pastebin.md)
