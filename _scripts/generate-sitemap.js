...
async function generateSitemap() {
    ...
    const robotsTxtContents = "Sitemap: https://interview-prep.shyamzzp.com/sitemap.xml";
...
async function getSitemap(allPageSuffixes) {
    const smStream = new SitemapStream({ hostname: 'https://interview-prep.shyamzzp.com/' });
